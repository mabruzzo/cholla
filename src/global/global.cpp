...
const std::set<std::string> optionalParams = { "flag_delta", "ddelta_dt", "n_delta", "Lz", "Lx", 
                                               "phi", "theta", "delta", "nzr", "nxr", "H0", 
                                               "Omega_M", "Omega_L", "Omega_R", "w0", "wa", 
                                               "Init_redshift", "End_redshift", "tile_length", 
