...
// NOLINTBEGIN(*)
const std::set<std::string> optionalParams = { // NOLINT
    "flag_delta",   "ddelta_dt",   "n_delta",  "Lz",       "Lx",      "phi", "theta", "delta", "nzr", "nxr", // NOLINT
    "H0",           "Omega_M",     "Omega_L",  "Omega_R",  "Omega_K", "w0",  "wa",    "Init_redshift", // NOLINT
    "End_redshift", "tile_length", "n_proc_x", "n_proc_y", "n_proc_z"}; // NOLINT
// NOLINTEND(*)
